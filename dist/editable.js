...
export function contractAttributes() {
 ...
 */
export function editable(basePath, key, kind = 'text') {
    if (!basePath)
        return {};
...
export function isPreview(locals) {
    return Boolean(locals && locals.codatiPreview === true);
}
/**
 ...
 */
export function showEmpty(locals, basePath) {
 ...
 */
export const EMPTY_IMAGE = 'data:image/svg+xml;charset=utf-8,' +
 ...
 */
export function global(campo, kind = 'text') {
 ...
 */
export function globalLink(campo) {
